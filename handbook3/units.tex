...
Before the turn of the twentieth century, the United States and the British governments had adopted the international yard and avoirdupois pound.  This move re-defined the pound and the yard (and all those related to them) in terms of the meter and kilogram using an exact relationship with finite precision.  The contemporary definitions for those fundamental units are constructed from highly stable natural phenomena may be independently reproduced in a laboratory, but this idea is quite recent.  Abandoning the tradition of defining units from a standard bar or mass did not happen until the latter half of the twentieth century. \cite{nbs:sp447}
...
To maintain transparency in regard to the standards used to derive unit conversions, the \PM\ units system includes a \verb|setup| function that is responsible for constructing all of the unit conversion routines.  Users can inspect the constants it defines, and users may change them at any time by re-calling the \verb|pm.units.setup(()| function with new arguments.  Its behavior is fully documented and can be found by evoking \verb|help| as below.
...
At the end of the nineteenth century, the definition of the avoirdupois pound was set to a fixed fraction of the kilogram, formalizing the definition of the pound officially as a measure of mass and not force.  The distinction became important as the precision of measuring instruments exceeded the consistency of the strength of gravity over the Earth's surface.  The contemporary value for the avoirdupois pound was established in the middle of the twentieth century, and is precisely 0.453 592 37 kg of mass.\cite{nbs:1959}  From this, the imperial ton (precisely 2,000 lb) and the long ton (precisely 2,240 lb) are derived.
...
Force is a concept that finds rigorous definition in Newton's laws of motion, so it is fitting that the principle force unit be called the newton.  It is equivalent to one kg m s$^{-2}$ \cite[p.137]{si:2019}, corresponding to mass times acceleration.
...
The dyne is mostly found in older scientific publications still using the centimeter-gram-second (CGS) system of units.  It is precisely 1 g cm s$^{-2}$.
...
Historically the English units for fluid ounce, pint, quart, and gallon were based on the volume occupied by specific weights of water.  The English wine gallon was first implemented in 1707 as precisely 231 cubic inches, which was quite close to the gallon based on quantities of water.  Though the United Kingdom abandoned it in 1824, it was adopted as the official gallon by the United States Treasury Department in 1832 \cite{nbs:sp447}.  Today, the US gallon is still defined as precisely 231 cubic inches (implicitly defining it from the meter).  The customary volumetric measurements quart (one quarter gallon), pint (one half quart), cup (one half pint), the fluid ounce (one eighth of a cup), tablespoon (one half of a fluid ounce), and teaspoon (one third of a table spoon), all follow from the gallon.  

It should be emphasized that these are ``fluid'' volumes, and are distinct from the system of ``dry'' volumes in common commercial use in agriculture.  There are also parallel definitions for UK imperial volumes that have slightly different definitions based on the imperial gallon. The fluid ounce is especially misleading, since it is within 4\% of the volume occupied by one ounce of liquid water -- it's historic definition.
