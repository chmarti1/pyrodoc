...
class UnitFormView{
    ...
    constructor(formHTMLid, valid_units, get_callback, set_callback) {
        this.change_units_callback = set_callback;
        this.get_current_callback = get_callback;
        ...
        this.init(valid_units, get_callback());
    }
    ...
    revert_onclick(){
        ...
        this.set_values(this.get_current_callback());
        this.button_apply.hide();
        this.button_revert.hide();
    }
